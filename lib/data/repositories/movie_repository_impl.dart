...
class MovieRepositoryImpl implements MovieRepository {
  ...
  @override
  Future<Either<Failure, MovieListEntity>> getPopularMovies({required int page}) async {
    try {
  ...
  @override
  Future<Either<Failure, MovieListEntity>> getNowPlayingMovies({required int page}) async {
    try {
